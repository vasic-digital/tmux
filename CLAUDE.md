...
- **Test-interrupt-on-discovery** (§11.4.4): any defect found during a test cycle **stops the cycle**. Fix at root cause + land 4 layers + rebuild + repeat. Layer 2 (runtime tests) and Layer 4 (paired mutation harness) landed.
