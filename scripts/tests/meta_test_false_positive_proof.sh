...
v109_run_mutation \
    ...
    "scripts/tmx" \
    "inplace_sed 's|_slice_props=( \"CPUQuota=\${TMX_WORK_CPU_EFFECTIVE}%\" \"TasksMax=\${TMX_TASKS_EFFECTIVE}\" )|_slice_props=( \"TasksMax=\${TMX_TASKS_EFFECTIVE}\" )|' \"\$target_abs\" && chmod 755 \"\$target_abs\"" \
    "scripts/tests/87_server_scope_split.sh" \
    "FAIL: G3"
