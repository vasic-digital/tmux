...
| `**Status:**` / `**Type:**` / `**Severity:**` / `**ATM-ID:**` body-field extraction | PASS | `TestRoundTrip_Idempotent` (second sync allocates 0 new ATM-NNN) |
...
§11.4.54 (ATM-NNN identifier) · §11.4.33 (type-aware closure) ·
